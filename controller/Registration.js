  ...
  userDetailsupdate: async (req, res) => {
    ...
    try {
      ...
      if ('Salary' in updates) {
        ...
        if (updates.Salary !== null && updates.Salary !== undefined && !isNaN(updates.Salary)) {
          ...
          // If Salary is present in updates but is null or undefined, you may handle it accordingly
          // For example, set updates.Salary = null or throw an error if it's not allowed to be null
        }
      
      
      if ('Password' in updates && updates.Password !== null && updates.Password !== undefined && updates.Password !== existingUser.Password) {
